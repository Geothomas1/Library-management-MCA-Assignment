...
{
$takev=mysql_query("select * from login where id='$check'");
$lv=mysql_num_rows($takev);
while($take=mysql_fetch_array($takev))	
{
$s=$take[3];
if($s=='admin'||$s=='user')
{
...
<table id="customers">
<tr>
<th>Name</th><th>Sex</th><th>Date of birth</th><th>Permenent Address</th><th>District</th><th>Email-Id</th><th>Phone Number</th><th> Delete</th><th>Leaners Details</th><th>Test Date</th><th>Status</th>
</tr>
<?php
...
$king=mysql_query("select * from result where userid='$ida'");
while($not=mysql_fetch_array($king))
{
$ch=$not[4];	
}
if($status=="1")
